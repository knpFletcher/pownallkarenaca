package com.karenpownall.android.aca.lifecycledemonstration;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "In onCreate", Toast.LENGTH_SHORT).show(); //call, intialize, and show in one line
        Log.i("info", "In onCreate"); //also dump to logcat
